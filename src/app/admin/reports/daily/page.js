  ...
  if (loading) {
    return (
      <ProtectedRoute allowedRoles={['superadmin', 'admin', 'lembaga']}>
        <AdminLayout pageTitle="Laporan Harian">
      ...
      <AdminLayout pageTitle="Laporan Harian">
        <div className="container-fluid">
          ...
          <div className="print-only text-center mb-4">
            <h2>Laporan Pendaftaran Harian</h2>
          ...
          <div className="d-flex justify-content-between align-items-center mb-4 no-print">
            <div>
              ...
              <h1 className="h3 mb-0 text-gray-800 mt-2">Laporan Harian</h1>
              <p className="text-muted mb-0">Statistik pendaftaran per hari</p>
            </div>
            <button 
              onClick={handlePrint}
                  ...
                  <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                      ...
                      <div className="h5 mb-0 font-weight-bold text-gray-800">
                        {getTotalByDate().toLocaleString('id-ID')}
                      </div>
                    </div>
                ...
                <div className="card-body">
                  <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                      ...
                      <div className="h5 mb-0 font-weight-bold text-gray-800">
                        {dailyData.length > 0 ? (getTotalByDate() / dailyData.length).toFixed(1) : '0'}
                      </div>
                    </div>
                    <div className="col-auto">
                    ...
                    <tbody>
                      {dailyData.map((day, index) => (
                        <tr key={day.date}>
                          ...
                          <td>{new Date(day.date).toLocaleDateString('id-ID', { weekday: 'long' })}</td>
                          <td className="fw-bold">{day.count}</td>
                          <td>
                            {Object.entries(day.lembaga).map(([lembaga, count]) => (
                              <span key={lembaga} className="badge bg-secondary me-1 mb-1">
                                {lembaga}: {count}
                              </span>
                            ))}
                          </td>
